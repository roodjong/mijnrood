    ...
    public function memberAcceptPersonalDetails(Request $request): Response {
        ...
        $form = $this->createFormBuilder($member)
            ->add('acceptUsePersonalInformation', null, [
                'label' => 'Ik ga ermee akkoord dat ROOD mijn persoonsgegevens opslaat in haar ledenadministratie, zoals beschreven in het <a href="https://{{ afdelingssite }}/privacybeleid">privacybeleid</a>.',
                'label_html' => true,
                'required' => true,
                'error_bubbling' => true,
